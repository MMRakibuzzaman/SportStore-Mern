> _This project is a proof-of-concept, fully generated by an AI assistant to showcase its capabilities in building a full-stack application. It is intended for demonstration purposes and not for production use._
